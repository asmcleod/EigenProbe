...
from EigenProbe.common import misc
from EigenProbe.common.baseclasses import ArrayWithAxes as AWA
from EigenProbe.common import numerics
from scipy.special import erf
from numpy import linalg
from EigenProbe.Materials import anisotropic
from EigenProbe.Materials import faddeeva
...
class SingleLayerGraphene(IsotropicSurface):
    ...
    def conductivity(self,freq,q=None):
        ...
        sigma=1j*self.sigma0 * (4/pi * f)/zeta_bar*self.layers
        
        sigma+=self.sigma0*self.residual_conductivity
